...
import { ArrowDown, BarChart, BarChart2, ChevronDown, ChevronUp, DollarSign, PiggyBank, Plus, TrendingUp as ProfitIcon, PieChart as PieChartIcon, ShoppingCart, TrendingDown, TrendingUp, Wallet } from "lucide-react";
...
const API_BASE = 'https://expensetracker-backend-dlxc.onrender.com/api';
 ...
 return (
    <div className={dashboardStyles.container}>
        ...
        <div className={dashboardStyles.summaryGrid}>
            ...
            additionalContent={
                <div className=" mt-2 text-xs text-cyan-600 flex item-center gap-2">
